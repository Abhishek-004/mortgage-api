package com.Mortgage.MortgageLoanAPI.models;
...
public class Employee {
	...
	public Employee(Long id, String first_name, String last_name, String gender, String email, String password,
			Timestamp created_on, Long created_by, Timestamp modifed_on, Long modified_by, boolean delete, int role) {
		super();
		this.id = id;
